 ...
 *   https://datatables.net/download/#bs5/dt-1.13.4/date-1.4.1/r-2.4.1/sp-2.1.2
 *
 * Included libraries:
 *   DataTables 1.13.4, DateTime 1.4.1, Responsive 2.4.1, SearchPanes 2.1.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.13.4/date-1.4.1/r-2.4.1/sp-2.1.2",
